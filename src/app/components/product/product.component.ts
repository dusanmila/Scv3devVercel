...
export class ProductComponent implements OnInit {
  ...
  displayedColumns = ['productName', 'weight', 'price', 'totalExpenses', 'category'];
  ...
  openDialog(flag: number, productIdCompany?: string, productName?: string, price?: number, weight?: number, totalExpenses?: number, productCategoryName?: string) {
    const dialogRef = this.dialog.open(ProductDialogComponent, { data: { productIdCompany, productName, price, weight, totalExpenses, productCategoryName } });
